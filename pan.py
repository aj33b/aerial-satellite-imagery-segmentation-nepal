...
class PAN(nn.Module):
    def __init__(self, in_channels=3, pretrained=True, fixed_feature_weights=True):
        super().__init__()
    ...
    def forward(self, x):
        ...
        n3 = self.smooth4(n3)
        n4 = p4 + self.downlayer2(n3)
        n4 = self.smooth5(n4)
        n5 = p5 + self.downlayer3(n4)
        n5 = self.smooth6(n5)
        ...
        return F.interpolate(F.sigmoid(depth), size=(256, 256), mode='bilinear')
